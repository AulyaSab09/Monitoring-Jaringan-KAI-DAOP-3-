    ...
    <div class="hidden lg:flex lg:w-3/12 bg-kai-navy relative flex-col justify-between p-10 text-white overflow-hidden">
        ...
        <div class="relative z-10 flex flex-col items-center w-full mt-10">
            ...
            <p class="text-lg opacity-95 font-medium leading-relaxed w-full text-justify px-1">
                Perbarui konfigurasi perangkat dan atur ulang urutan tampilan secara visual. Gunakan referensi perangkat yang sudah ada untuk menentukan posisi.
            </p>
        </div>
    ...
    <div class="w-full lg:w-9/12 flex items-start justify-center p-8 md:p-12 bg-white min-h-full">        
        <div class="w-full max-w-6xl px-10 py-10">            
            <div class="mb-12">
                ...
                <p class="text-xl text-gray-400 font-medium italic mt-2">Perbarui informasi: <span class="text-kai-navy font-bold">{{ $monitor->name }}</span></p>
            </div>
            ...
            <form action="{{ route('monitor.update', $monitor->id) }}" method="POST" class="space-y-10">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-10">
                    ...
                    <div class="space-y-3">
                        ...
                        <input type="text" name="name" value="{{ old('name', $monitor->name) }}" class="w-full px-6 py-5 bg-gray-50 border-2 border-gray-200 rounded-2xl focus:border-[#001D4B] focus:ring-4 focus:ring-blue-100 transition-all font-bold text-2xl text-kai-navy outline-none" required>
                    </div>

                    {{-- IP Address --}}
                    <div class="space-y-3">
                        <label class="text-lg font-black uppercase tracking-[0.2em] text-kai-navy opacity-80">Alamat IP (IPv4)</label>
                        <input type="text" name="ip_address" value="{{ old('ip_address', $monitor->ip_address) }}" class="w-full px-6 py-5 bg-gray-50 border-2 border-gray-200 rounded-2xl focus:border-[#001D4B] focus:ring-4 focus:ring-blue-100 transition-all font-bold text-2xl text-kai-navy outline-none" required>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-10">
                    <div class="space-y-3">
                        ...
                        <input type="text" name="location" value="{{ old('location', $monitor->location) }}" class="w-full px-6 py-5 bg-gray-50 border-2 border-gray-200 rounded-2xl focus:border-[#001D4B] focus:ring-4 focus:ring-blue-100 transition-all font-bold text-2xl text-kai-navy outline-none">
                    </div>
                    <div class="space-y-3">
                        <label class="text-lg font-black uppercase tracking-[0.2em] text-kai-navy opacity-80">Kode Stasiun</label>
                        <input type="text" name="kode_lokasi" value="{{ old('kode_lokasi', $monitor->kode_lokasi) }}" class="w-full px-6 py-5 bg-gray-50 border-2 border-gray-200 rounded-2xl focus:border-[#001D4B] focus:ring-4 focus:ring-blue-100 transition-all font-bold text-2xl text-kai-navy outline-none">
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-10">
                    <div class="space-y-3">
                        ...
                        <div class="relative">
                            <select name="type" class="w-full appearance-none px-6 py-5 bg-gray-50 border-2 border-gray-200 rounded-2xl focus:border-[#001D4B] focus:ring-4 focus:ring-blue-100 transition-all font-bold text-2xl text-kai-navy cursor-pointer outline-none">
                                ...
                                <option value="PC" {{ old('type', $monitor->type) == 'PC' ? 'selected' : '' }}>PC / Server</option>
                                <option value="Modem" {{ old('type', $monitor->type) == 'Modem' ? 'selected' : '' }}>Modem</option>
                            </select>
                    ...
                    <div class="space-y-3">
                        <label class="text-lg font-black uppercase tracking-[0.2em] text-kai-navy opacity-80">Parent Device (Induk)</label>
                    <div class="relative">
                        <select name="parent_id" class="w-full appearance-none px-6 py-5 bg-gray-50 border-2 border-gray-200 rounded-2xl focus:border-[#001D4B] focus:ring-4 focus:ring-blue-100 transition-all font-bold text-xl text-kai-navy cursor-pointer outline-none">
                    ...
                    <p class="text-sm text-gray-400 italic">Ubah ke "Tidak Ada Parent" jika ingin menjadikan perangkat ini sebagai Root di dashboard.</p>
                    </div>
                </div>
