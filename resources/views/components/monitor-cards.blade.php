@foreach($monitors as $monitor)
    @php
        ...
        $colors = [
            'Connected' => ['bg' => 'bg-emerald-50', 'border' => 'border-emerald-300', 'dot' => 'bg-emerald-500', 'text' => 'text-emerald-700', 'badge' => 'AMAN', 'line' => 'connected'],
            'Unstable'  => ['bg' => 'bg-orange-50', 'border' => 'border-orange-300', 'dot' => 'bg-orange-500',  'text' => 'text-orange-700',  'badge' => 'CEK', 'line' => 'unstable'],
            'Disconnected' => ['bg' => 'bg-red-50', 'border' => 'border-red-300', 'dot' => 'bg-red-500', 'text' => 'text-red-700', 'badge' => 'MATI', 'line' => 'disconnected'],
